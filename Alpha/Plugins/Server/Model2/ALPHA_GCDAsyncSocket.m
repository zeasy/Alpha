...
/**
 * Does ARC support support ALPHA_GCD objects?
...
// Logging uses the CocoaLumberjack framework (which is also ALPHA_GCD based).
...
NSString *const ALPHA_GCDAsyncSocketException = @"ALPHA_GCDAsyncSocketException";
NSString *const ALPHA_GCDAsyncSocketErrorDomain = @"ALPHA_GCDAsyncSocketErrorDomain";

NSString *const ALPHA_GCDAsyncSocketQueueName = @"ALPHA_GCDAsyncSocket";
NSString *const ALPHA_GCDAsyncSocketThreadName = @"ALPHA_GCDAsyncSocket-CFStream";

#if SECURE_TRANSPORT_MAYBE_AVAILABLE
NSString *const ALPHA_GCDAsyncSocketSSLCipherSuites = @"ALPHA_GCDAsyncSocketSSLCipherSuites";
#if TARGET_OS_IPHONE
NSString *const ALPHA_GCDAsyncSocketSSLProtocolVersionMin = @"ALPHA_GCDAsyncSocketSSLProtocolVersionMin";
NSString *const ALPHA_GCDAsyncSocketSSLProtocolVersionMax = @"ALPHA_GCDAsyncSocketSSLProtocolVersionMax";
#else
NSString *const ALPHA_GCDAsyncSocketSSLDiffieHellmanParameters = @"ALPHA_GCDAsyncSocketSSLDiffieHellmanParameters";
#endif
#endif

enum ALPHA_GCDAsyncSocketFlags
{
...
enum ALPHA_GCDAsyncSocketConfig
{
...
@interface ALPHA_GCDAsyncSocket ()
{
	uint32_t flags;
	uint16_t config;
	...
	ALPHA_GCDAsyncReadPacket *currentRead;
	ALPHA_GCDAsyncWritePacket *currentWrite;
	
	unsigned long socketFDBytesAvailable;
	
	ALPHA_GCDAsyncSocketPreBuffer *preBuffer;
	...
	ALPHA_GCDAsyncSocketPreBuffer *sslPreBuffer;
...
@interface ALPHA_GCDAsyncSocketPreBuffer : NSObject
{
	uint8_t *preBuffer;
...
@implementation ALPHA_GCDAsyncSocketPreBuffer
...
/**
 * The ALPHA_GCDAsyncReadPacket encompasses the instructions for any given read.
 * The content of a read packet allows the code to determine if we're:
 *  - reading to a certain length
 *  - reading to a certain separator
 *  - or simply reading the first chunk of available data
**/
@interface ALPHA_GCDAsyncReadPacket : NSObject
{
  @public
...
- (NSUInteger)readLengthForTermWithPreBuffer:(ALPHA_GCDAsyncSocketPreBuffer *)preBuffer found:(BOOL *)foundPtr;

- (NSInteger)searchForTermAfterPreBuffering:(ssize_t)numBytes;

@end

@implementation ALPHA_GCDAsyncReadPacket
...
/**
 * The ALPHA_GCDAsyncWritePacket encompasses the instructions for any given write.
**/
@interface ALPHA_GCDAsyncWritePacket : NSObject
{
  @public
	NSData *buffer;
	NSUInteger bytesDone;
...
@implementation ALPHA_GCDAsyncWritePacket
...
/**
 * The ALPHA_GCDAsyncSpecialPacket encompasses special instructions for interruptions in the read/write queues.
 * This class my be altered to support more than just TLS in the future.
**/
@interface ALPHA_GCDAsyncSpecialPacket : NSObject
{
  @public
...
@implementation ALPHA_GCDAsyncSpecialPacket
...
@implementation ALPHA_GCDAsyncSocket
...
- (id)initWithDelegate:(id)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq
{
	if((self = [super init]))
	{
		...
		{
			socketQueue = dispatch_queue_create([ALPHA_GCDAsyncSocketQueueName UTF8String], NULL);
		}
		...
		preBuffer = [[ALPHA_GCDAsyncSocketPreBuffer alloc] initWithCapacity:(1024 * 4)];
	}
	return self;
}
...
- (BOOL)doAccept:(int)parentSocketFD
{
	...
	if (delegateQueue)
	{
		...
		dispatch_async(delegateQueue, ^{ @autoreleasepool {
			...
			// Create ALPHA_GCDAsyncSocket instance for accepted socket
			
			ALPHA_GCDAsyncSocket *acceptedSocket = [[ALPHA_GCDAsyncSocket alloc] initWithDelegate:theDelegate
...
- (NSError *)badConfigError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:ALPHA_GCDAsyncSocketErrorDomain code:ALPHA_GCDAsyncSocketBadConfigError userInfo:userInfo];
}
...
- (NSError *)badParamError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:ALPHA_GCDAsyncSocketErrorDomain code:ALPHA_GCDAsyncSocketBadParamError userInfo:userInfo];
}
...
- (NSError *)connectTimeoutError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"ALPHA_GCDAsyncSocketConnectTimeoutError",
	                                                     @"ALPHA_GCDAsyncSocket", [NSBundle mainBundle],
	                                                     @"Attempt to connect to host timed out", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:ALPHA_GCDAsyncSocketErrorDomain code:ALPHA_GCDAsyncSocketConnectTimeoutError userInfo:userInfo];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"ALPHA_GCDAsyncSocketReadMaxedOutError",
														 @"ALPHA_GCDAsyncSocket", [NSBundle mainBundle],
														 @"Read operation reached set maximum length", nil);
	
	NSDictionary *info = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:ALPHA_GCDAsyncSocketErrorDomain code:ALPHA_GCDAsyncSocketReadMaxedOutError userInfo:info];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"ALPHA_GCDAsyncSocketReadTimeoutError",
	                                                     @"ALPHA_GCDAsyncSocket", [NSBundle mainBundle],
	                                                     @"Read operation timed out", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:ALPHA_GCDAsyncSocketErrorDomain code:ALPHA_GCDAsyncSocketReadTimeoutError userInfo:userInfo];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"ALPHA_GCDAsyncSocketWriteTimeoutError",
	                                                     @"ALPHA_GCDAsyncSocket", [NSBundle mainBundle],
	                                                     @"Write operation timed out", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:ALPHA_GCDAsyncSocketErrorDomain code:ALPHA_GCDAsyncSocketWriteTimeoutError userInfo:userInfo];
}

- (NSError *)connectionClosedError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"ALPHA_GCDAsyncSocketClosedError",
	                                                     @"ALPHA_GCDAsyncSocket", [NSBundle mainBundle],
	                                                     @"Socket closed by remote peer", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:ALPHA_GCDAsyncSocketErrorDomain code:ALPHA_GCDAsyncSocketClosedError userInfo:userInfo];
}
...
- (NSError *)otherError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:ALPHA_GCDAsyncSocketErrorDomain code:ALPHA_GCDAsyncSocketOtherError userInfo:userInfo];
}
...
- (BOOL)usingCFStreamForTLS
{
	...
	{	
		if ((flags & kSocketSecure) && (flags & kUsingCFStreamForTLS))
		{
			...
			// 
			// Thus we're not able to use the ALPHA_GCD read/write sources in this particular scenario.
                        ...
                        tag:(long)tag
{
	...
	ALPHA_GCDAsyncReadPacket *packet = [[ALPHA_GCDAsyncReadPacket alloc] initWithData:buffer
	                                                          startOffset:offset
	                                                            maxLength:length
	                                                              timeout:timeout
	                                                           readLength:0
...
- (float)progressOfReadReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	...
	dispatch_block_t block = ^{
		...
		if (!currentRead || ![currentRead isKindOfClass:[ALPHA_GCDAsyncReadPacket class]])
		{
...
- (void)maybeDequeueRead
{
	...
	if ((currentRead == nil) && (flags & kConnected))
	{
		if ([readQueue count] > 0)
		{
			...
			if ([currentRead isKindOfClass:[ALPHA_GCDAsyncSpecialPacket class]])
			{
				LogVerbose(@"Dequeued ALPHA_GCDAsyncSpecialPacket");
			...
			{
				LogVerbose(@"Dequeued ALPHA_GCDAsyncReadPacket");
...
- (void)completeCurrentRead
{
	...
	{
		__strong id theDelegate = delegate;
		ALPHA_GCDAsyncReadPacket *theRead = currentRead; // Ensure currentRead retained since result may not own buffer
...
- (void)doReadTimeout
{
	...
	{
		__strong id theDelegate = delegate;
		ALPHA_GCDAsyncReadPacket *theRead = currentRead;
...
- (void)writeData:(NSData *)data withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	ALPHA_GCDAsyncWritePacket *packet = [[ALPHA_GCDAsyncWritePacket alloc] initWithData:data timeout:timeout tag:tag];
...
- (float)progressOfWriteReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	...
	dispatch_block_t block = ^{
		...
		if (!currentWrite || ![currentWrite isKindOfClass:[ALPHA_GCDAsyncWritePacket class]])
		{
...
- (void)maybeDequeueWrite
{
	...
	if ((currentWrite == nil) && (flags & kConnected))
	{
		if ([writeQueue count] > 0)
		{
			...
			if ([currentWrite isKindOfClass:[ALPHA_GCDAsyncSpecialPacket class]])
			{
				LogVerbose(@"Dequeued ALPHA_GCDAsyncSpecialPacket");
			...
			{
				LogVerbose(@"Dequeued ALPHA_GCDAsyncWritePacket");
...
- (void)doWriteData
{
	...
	// Note: This method is not called if currentWrite is a ALPHA_GCDAsyncSpecialPacket (startTLS packet)
...
- (void)doWriteTimeout
{
	...
	{
		__strong id theDelegate = delegate;
		ALPHA_GCDAsyncWritePacket *theWrite = currentWrite;
...
- (void)startTLS:(NSDictionary *)tlsSettings
{
	...
	ALPHA_GCDAsyncSpecialPacket *packet = [[ALPHA_GCDAsyncSpecialPacket alloc] initWithTLSSettings:tlsSettings];
...
- (void)maybeStartTLS
{
	...
	if ((flags & kStartingReadTLS) && (flags & kStartingWriteTLS))
	{
		...
		#if TARGET_OS_IPHONE
		{
			ALPHA_GCDAsyncSpecialPacket *tlsPacket = (ALPHA_GCDAsyncSpecialPacket *)currentRead;
...
{
	ALPHA_GCDAsyncSocket *asyncSocket = (__bridge ALPHA_GCDAsyncSocket *)connection;
...
- (void)ssl_startTLS
{
	...
	// 7. kCFStreamSSLLevel (ALPHA_GCDAsyncSocketSSLProtocolVersionMin / ALPHA_GCDAsyncSocketSSLProtocolVersionMax)
	// 8. ALPHA_GCDAsyncSocketSSLCipherSuites
	// 9. ALPHA_GCDAsyncSocketSSLDiffieHellmanParameters (Mac)
	...
	#if TARGET_OS_IPHONE
	{
		...
		NSString *sslMinLevel = [tlsSettings objectForKey:ALPHA_GCDAsyncSocketSSLProtocolVersionMin];
		NSString *sslMaxLevel = [tlsSettings objectForKey:ALPHA_GCDAsyncSocketSSLProtocolVersionMax];
		...
		if (sslLevel)
		{
			if (sslMinLevel || sslMaxLevel)
			{
				LogWarn(@"kCFStreamSSLLevel security option ignored. Overriden by "
						@"ALPHA_GCDAsyncSocketSSLProtocolVersionMin and/or ALPHA_GCDAsyncSocketSSLProtocolVersionMax");
			}
			else
			{
	...
	value = [tlsSettings objectForKey:ALPHA_GCDAsyncSocketSSLCipherSuites];
	if (value)
	{
	...
	// 9. ALPHA_GCDAsyncSocketSSLDiffieHellmanParameters
	
	#if !TARGET_OS_IPHONE
	value = [tlsSettings objectForKey:ALPHA_GCDAsyncSocketSSLDiffieHellmanParameters];
	if (value)
	{
	...
	sslPreBuffer = [[ALPHA_GCDAsyncSocketPreBuffer alloc] initWithCapacity:(1024 * 4)];
...
- (void)cf_startTLS
{
	...
	NSAssert([currentRead isKindOfClass:[ALPHA_GCDAsyncSpecialPacket class]], @"Invalid read packet for startTLS");
	NSAssert([currentWrite isKindOfClass:[ALPHA_GCDAsyncSpecialPacket class]], @"Invalid write packet for startTLS");
...
{
	[[NSThread currentThread] setName:ALPHA_GCDAsyncSocketThreadName];
...
+ (void)scheduleCFStreams:(ALPHA_GCDAsyncSocket *)asyncSocket
{
	LogTrace();
...
+ (void)unscheduleCFStreams:(ALPHA_GCDAsyncSocket *)asyncSocket
{
	LogTrace();
	NSAssert([NSThread currentThread] == cfstreamThread, @"Invoked on wrong thread");
...
{
	ALPHA_GCDAsyncSocket *asyncSocket = (__bridge ALPHA_GCDAsyncSocket *)pInfo;
